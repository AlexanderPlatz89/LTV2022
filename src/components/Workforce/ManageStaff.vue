<template>
        ...
        <div class="grid col-12">
            <div class="col-6">
				...
				<Fieldset>
					...
					<ul>
						<il v-for="worker in findWorkerInsicknessAndHolidays()" :key="worker">{{ worker.surname }}</il>
					</ul>
				</Fieldset>
				<Fieldset>
                    <template #legend>
                ...
                <Fieldset>
                    ...
                    <div class="grid">
                        <div class="col-4 container-input-add-worker">
                            ...
                            <Dropdown v-model="helperT4_1" style="width: 10em" :options="workers" @change="setAiutant(1, 'T4', helperT4_1)" :placeholder="$t('manageStaff.helper')" optionLabel="surname" optionValue="id" />
                ...
                <Fieldset>
                    ...
                    <div class="grid">
                        <div class="col-4 container-input-add-worker">
                            ...
                            <Dropdown v-model="helperT5_1" style="width: 10em" :options="workers" @change="setAiutant(1, 'T5', helperT5_1)" :placeholder="$t('manageStaff.helper')" optionLabel="surname" optionValue="id" />
                ...
                <Fieldset>
                    ...
                    <div class="grid">
                        <div class="col-4 container-input-add-worker">
                            ...
                            <Dropdown v-model="helperT6_1" style="width: 10em" :options="workers" @change="setAiutant(1, 'T6', helperT6_1)" :placeholder="$t('manageStaff.helper')" optionLabel="surname" optionValue="id" />
                ...
                <Fieldset>
                    ...
                    <div class="grid">
                        <div class="col-4 container-input-add-worker">
                            ...
                            <Dropdown v-model="helperT7_1" style="width: 10em" :options="workers" @change="setAiutant(1, 'T7', helperT7_1)" :placeholder="$t('manageStaff.helper')" optionLabel="surname" optionValue="id" />
    ...
    <div class="layout-dashboard">
        <Button style="float: right" :label="$t('manageStaff.nextTurns')" icon="pi pi-plus" iconPos="right" @click="openTurnDialog()" />
        <Button style="float: right" :label="$t('manageStaff.actualTurns')" icon="pi pi-plus" iconPos="right" @click="openActualTurnsDialog()" />
...
export default {
    ...
    data() {
        return {
            ...
            turns: [
				...
				{ description: this.$t('turn.4'), code: 4 },
				{ description: this.$t('turn.5'), code: 5 },
            ],
            departments: [
    ...
    methods: {
		...
		findWorkerInsicknessAndHolidays(){
			const workerList = this.workers.filter((worker) => worker.turn == 4)
			return workerList != null ? workerList : [];
		},
