<template>
    <h5 style="margin-top: 0.5em; text-align: center; background-color: rgba(128, 128, 128, 0.19); border: 4px solid rgba(0, 255, 238, 0.474)">T7</h5>
    <Chart type="line" :data="outputT7" :options="chartCSS" />
</template>
...
export default {
    created() {
        this.outputT7.datasets[0].data = this.$filters.deepClone(this.productionData)
        this.outputT7.labels = this.$filters.deepClone(this.timeList)
        this.outputT7.datasets[1].data = this.$filters.deepClone(this.plannedProductionList)
    ...
    data() {
        return {
            ...
            time: 12,
            day: 1,
            productionData: [2000, 5200, 6500, 2000, 0, 200, 2400],
