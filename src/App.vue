<template>
	<div :class="containerClass" @click="onDocumentClick">
		...
		<AppTopBar :topbarMenuActive="topbarMenuActive" :activeTopbarItem="activeTopbarItem"
			:horizontal="isHorizontal()" :profileMode="profileMode" @menubutton-click="onMenuButtonClick"
	...
	data() {
		return {
			...
			menu: [
				...
				{ label: this.$t('menu.manageWorksheets'), icon: 'pi pi-book', to: '/manageWorksheets' },
			]
		}
	},
	watch: {
